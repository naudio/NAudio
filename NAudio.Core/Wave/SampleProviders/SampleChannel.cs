...
namespace NAudio.Wave.SampleProviders
{
    ...
    public class SampleChannel : ISampleProvider
    {
        ...
        /// </summary>
        /// <param name="waveProvider">Source audio, must be PCM or IEEE</param>
        ...
        {
            ISampleProvider sampleProvider = SampleProviderConverters
                .ConvertWaveProviderIntoSampleProvider(waveProvider);
