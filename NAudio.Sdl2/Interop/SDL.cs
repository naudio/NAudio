...
#pragma warning restore 0169
        ...
        private static extern int INTERNAL_SDL_GetDefaultAudioInfo(
            out IntPtr name,
            out SDL_AudioSpec spec,
            int iscapture
        );
        public unsafe static int SDL_GetDefaultAudioInfo(
            out string name,
            out SDL_AudioSpec spec,
            int iscapture
        )
        {
            ...
            var audioInfo = INTERNAL_SDL_GetDefaultAudioInfo(out ptr, out spec, iscapture);
            name = UTF8_ToManaged(ptr);
            return audioInfo;
        }
