...
namespace NAudio.MediaFoundation
{
	...
	/// https://docs.microsoft.com/en-us/windows/win32/api/mfidl/nn-mfidl-imfpresentationdescriptor
	/// </summary>
	...
	public interface IMFPresentationDescriptor
	{
		...
		/// Each stream descriptor contains information about one stream in the media source. 
		/// To retrieve a stream descriptor, call the IMFPresentationDescriptor::GetStreamDescriptorByIndex method.
		/// </summary>
		...
		/// </summary>
		void GetStreamDescriptorByIndex(uint dwIndex, out bool pfSelected, out IMFStreamDescriptor ppDescriptor);
		/// <summary>
