...
{
    [TestFixture]
    public class WaveFileForwardOnlyReaderTests
    {
        [Test]
        [Category("UnitTest")]
        ...
        public void CanLoadAndReadVariousProblemWavFiles()
        {
            ...
            foreach (string file in Directory.GetFiles(testDataFolder, "*.wav"))
            {
                ...
                using (var reader = new WaveFileForwardOnlyReader(wavFile))
                {
        ...
        public void DisposeOfStreamWhenConstructedFromFilePath()
        {
            ...
            try
            {
                var waveReader = new WaveFileForwardOnlyReader(tempFilePath);
