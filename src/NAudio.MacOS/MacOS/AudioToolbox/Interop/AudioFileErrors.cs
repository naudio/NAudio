...
internal static class AudioFileErrors
{
    ...
    public static readonly int kAudioFileUnspecifiedError						= MacUtils.ConstructIntConstantValueFromString("wht?");		// 0x7768743F, 2003334207
    /// <summary>The file type is not supported.</summary>
    public static readonly int kAudioFileUnsupportedFileTypeError 				= MacUtils.ConstructIntConstantValueFromString("typ?");		// 0x7479703F, 1954115647
    /// <summary>The data format is not supported by this file type.</summary>
    public static readonly int kAudioFileUnsupportedDataFormatError 			= MacUtils.ConstructIntConstantValueFromString("fmt?");		// 0x666D743F, 1718449215
    /// <summary>The property is not supported.</summary>
    public static readonly int kAudioFileUnsupportedPropertyError 				= MacUtils.ConstructIntConstantValueFromString("pty?");		// 0x7074793F, 1886681407
    /// <summary>The size of the property data was not correct.</summary>
    public static readonly int kAudioFileBadPropertySizeError 					= MacUtils.ConstructIntConstantValueFromString("!siz");		// 0x2173697A,  561211770
    /// <summary>
    /// The operation violated the file permissions.
    /// For example, trying to write to a file opened with kAudioFileReadPermission.
    /// </summary>
    public static readonly int kAudioFilePermissionsError	 					= MacUtils.ConstructIntConstantValueFromString("prm?");		// 0x70726D3F, 1886547263
    /// <summary>
    ...
    /// </summary>
    public static readonly int kAudioFileNotOptimizedError						= MacUtils.ConstructIntConstantValueFromString("optm");       // 0x6F70746D, 1869640813
    ...
    /// </summary>
    public static readonly int kAudioFileInvalidChunkError						= MacUtils.ConstructIntConstantValueFromString("chk?");		// 0x63686B3F, 1667787583
    /// <summary>
    /// The a file offset was too large for the file type. AIFF and WAVE have a 32 bit file size limit. 
    /// </summary>
    public static readonly int kAudioFileDoesNotAllow64BitDataSizeError		    = MacUtils.ConstructIntConstantValueFromString("off?");		// 0x6F66663F, 1868981823
    /// <summary>
    ...
    /// </summary>
    public static readonly int kAudioFileInvalidPacketOffsetError				= MacUtils.ConstructIntConstantValueFromString("pck?");		// 0x70636B3F, 1885563711
    /// <summary>
    ...
    /// </summary>
    public static readonly int kAudioFileInvalidPacketDependencyError			= MacUtils.ConstructIntConstantValueFromString("dep?");		// 0x6465703F, 1684369471
    /// <summary>
    /// The file is malformed, or otherwise not a valid instance of an audio file of its type. 
    /// </summary>
    public static readonly int kAudioFileInvalidFileError						= MacUtils.ConstructIntConstantValueFromString("dta?");		// 0x6474613F, 1685348671
    /// <summary>
    ...
    /// </summary>
    public static readonly int kAudioFileOperationNotSupportedError			    = MacUtils.ConstructIntConstantValueFromString("op??");       // 0x6F703F3F, integer used because of trigraph
