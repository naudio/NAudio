...
internal static class AudioClockDeviceProperties
{
    ...
    /// </summary>
    public static readonly AudioObjectPropertySelector kAudioClockDevicePropertyDeviceUID                   = (AudioObjectPropertySelector)MacUtils.ConstructUIntConstantValueFromString("cuid");
    /// <summary>
    ...
    /// </summary>
    public static readonly AudioObjectPropertySelector kAudioClockDevicePropertyTransportType               = (AudioObjectPropertySelector)MacUtils.ConstructUIntConstantValueFromString("tran");
    /// <summary>
    ...
    /// </summary>
    public static readonly AudioObjectPropertySelector kAudioClockDevicePropertyClockDomain                 = (AudioObjectPropertySelector)MacUtils.ConstructUIntConstantValueFromString("clkd");
    /// <summary>
    ...
    /// </summary>
    public static readonly AudioObjectPropertySelector kAudioClockDevicePropertyDeviceIsAlive               = (AudioObjectPropertySelector)MacUtils.ConstructUIntConstantValueFromString("livn");
    /// <summary>
    ...
    /// </summary>
    public static readonly AudioObjectPropertySelector kAudioClockDevicePropertyDeviceIsRunning             = (AudioObjectPropertySelector)MacUtils.ConstructUIntConstantValueFromString("goin");
    /// <summary>
    /// A UInt32 containing the number of frames of latency in the AudioClockDevice.
    /// </summary>
    public static readonly AudioObjectPropertySelector kAudioClockDevicePropertyLatency                     = (AudioObjectPropertySelector)MacUtils.ConstructUIntConstantValueFromString("ltnc");
    /// <summary>
    ...
    /// </summary>
    public static readonly AudioObjectPropertySelector kAudioClockDevicePropertyControlList                 = (AudioObjectPropertySelector)MacUtils.ConstructUIntConstantValueFromString("ctrl");
    /// <summary>
    /// A Float64 that indicates the current nominal sample rate of the AudioClockDevice.
    /// </summary>
    public static readonly AudioObjectPropertySelector kAudioClockDevicePropertyNominalSampleRate           = (AudioObjectPropertySelector)MacUtils.ConstructUIntConstantValueFromString("nsrt");
    /// <summary>
    /// An array of AudioValueRange structs that indicates the valid ranges for the 
    /// nominal sample rate of the AudioClockDevice.
    /// </summary>
    public static readonly AudioObjectPropertySelector kAudioClockDevicePropertyAvailableNominalSampleRates = (AudioObjectPropertySelector)MacUtils.ConstructUIntConstantValueFromString("nsr#");
}