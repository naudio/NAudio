...
internal static class AudioDeviceProperties
{
    ...
    /// </summary>
    public static readonly AudioObjectPropertySelector kAudioDevicePropertyPlugIn                          = (AudioObjectPropertySelector)MacUtils.ConstructUIntConstantValueFromString("plug"u8);
    /// <summary>
    ...
    /// </summary>
    public static readonly AudioObjectPropertySelector kAudioDevicePropertyDeviceHasChanged                = (AudioObjectPropertySelector)MacUtils.ConstructUIntConstantValueFromString("diff"u8);
    /// <summary>
    ...
    /// </summary>
    public static readonly AudioObjectPropertySelector kAudioDevicePropertyDeviceIsRunningSomewhere        = (AudioObjectPropertySelector)MacUtils.ConstructUIntConstantValueFromString("gone"u8);
    /// <summary>
    ...
    /// usually sent from the AudioDevice's IO thread.
    /// </summary>
    public static readonly AudioObjectPropertySelector kAudioDeviceProcessorOverload                       = (AudioObjectPropertySelector)MacUtils.ConstructUIntConstantValueFromString("over"u8);
    /// <summary>
    /// A UInt32 where the value has no meaning. This property exists so that
    ...
    /// </summary>
    public static readonly AudioObjectPropertySelector kAudioDevicePropertyIOStoppedAbnormally             = (AudioObjectPropertySelector)MacUtils.ConstructUIntConstantValueFromString("stpd"u8);
    /// <summary>
    ...
    /// property.
    /// </summary>
    public static readonly AudioObjectPropertySelector kAudioDevicePropertyHogMode                         = (AudioObjectPropertySelector)MacUtils.ConstructUIntConstantValueFromString("oink"u8);
    /// <summary>
    /// A UInt32 whose value indicates the number of frames in the IO buffers.
    /// </summary>
    public static readonly AudioObjectPropertySelector kAudioDevicePropertyBufferFrameSize                 = (AudioObjectPropertySelector)MacUtils.ConstructUIntConstantValueFromString("fsiz"u8);
    /// <summary>
    /// An AudioValueRange indicating the minimum and maximum values, inclusive, for
    /// kAudioDevicePropertyBufferFrameSize.
    /// </summary>
    public static readonly AudioObjectPropertySelector kAudioDevicePropertyBufferFrameSizeRange            = (AudioObjectPropertySelector)MacUtils.ConstructUIntConstantValueFromString("fsz#"u8);
    /// <summary>
    ...
    /// </summary>
    public static readonly AudioObjectPropertySelector kAudioDevicePropertyUsesVariableBufferFrameSizes    = (AudioObjectPropertySelector)MacUtils.ConstructUIntConstantValueFromString("vfsz"u8);
    /// <summary>
    ...
    /// cycle.
    /// </summary>
    public static readonly AudioObjectPropertySelector kAudioDevicePropertyIOCycleUsage                    = (AudioObjectPropertySelector)MacUtils.ConstructUIntConstantValueFromString("ncyc"u8);
    /// <summary>
    ...
    /// </summary>
    public static readonly AudioObjectPropertySelector kAudioDevicePropertyStreamConfiguration             = (AudioObjectPropertySelector)MacUtils.ConstructUIntConstantValueFromString("slay"u8);
    /// <summary>
    ...
    /// </summary>
    public static readonly AudioObjectPropertySelector kAudioDevicePropertyIOProcStreamUsage               = (AudioObjectPropertySelector)MacUtils.ConstructUIntConstantValueFromString("suse"u8);
    /// <summary>
    /// A Float64 that indicates the current actual sample rate of the AudioDevice
    /// as measured by its time stamps.
    /// </summary>
    public static readonly AudioObjectPropertySelector kAudioDevicePropertyActualSampleRate                = (AudioObjectPropertySelector)MacUtils.ConstructUIntConstantValueFromString("asrt"u8);
    /// <summary>
    ...
    /// </summary>
    public static readonly AudioObjectPropertySelector kAudioDevicePropertyClockDevice                     = (AudioObjectPropertySelector)MacUtils.ConstructUIntConstantValueFromString("apcd"u8);
    /// <summary>
    ...
    /// object.
    /// </summary>
    public static readonly AudioObjectPropertySelector kAudioDevicePropertyIOThreadOSWorkgroup             = (AudioObjectPropertySelector)MacUtils.ConstructUIntConstantValueFromString("oswg"u8);
    /// <summary>
    ...
    /// </summary>
    public static readonly AudioObjectPropertySelector kAudioDevicePropertyProcessMute					   = (AudioObjectPropertySelector)MacUtils.ConstructUIntConstantValueFromString("appm"u8);
}