...
internal static class AudioSelectorControlProperties
{
    ...
    /// </summary>
    public static readonly AudioObjectPropertySelector kAudioSelectorControlPropertyCurrentItem    = (AudioObjectPropertySelector)MacUtils.ConstructUIntConstantValueFromString("scci"u8);
    /// <summary>
    /// An array of UInt32s that represent the IDs of all the items available.
    /// </summary>
    public static readonly AudioObjectPropertySelector kAudioSelectorControlPropertyAvailableItems = (AudioObjectPropertySelector)MacUtils.ConstructUIntConstantValueFromString("scai"u8);
    /// <summary>
    ...
    /// </summary>
    public static readonly AudioObjectPropertySelector kAudioSelectorControlPropertyItemName       = (AudioObjectPropertySelector)MacUtils.ConstructUIntConstantValueFromString("scin"u8);
    /// <summary>
    ...
    /// </summary>
    public static readonly AudioObjectPropertySelector kAudioSelectorControlPropertyItemKind       = (AudioObjectPropertySelector)MacUtils.ConstructUIntConstantValueFromString("clkk"u8);
}
