...
internal static class AudioStreamProperties
{
    ...
    /// </summary>
    public static readonly AudioObjectPropertySelector kAudioStreamPropertyIsActive                    = (AudioObjectPropertySelector)MacUtils.ConstructUIntConstantValueFromString("sact"u8); // 'sact',
    /// <summary>
    ...
    /// </summary>
    public static readonly AudioObjectPropertySelector kAudioStreamPropertyDirection                   = (AudioObjectPropertySelector)MacUtils.ConstructUIntConstantValueFromString("sdir"u8); // 'sdir',
    /// <summary>
    /// A UInt32 whose value describes the general kind of functionality attached to the AudioStream.
    /// </summary>
    public static readonly AudioObjectPropertySelector kAudioStreamPropertyTerminalType                = (AudioObjectPropertySelector)MacUtils.ConstructUIntConstantValueFromString("term"u8); // 'term',
    /// <summary>
    /// A UInt32 that specifies the first element in the owning 
    /// device that corresponds to element one of this stream.
    /// </summary>
    public static readonly AudioObjectPropertySelector kAudioStreamPropertyStartingChannel             = (AudioObjectPropertySelector)MacUtils.ConstructUIntConstantValueFromString("schn"u8); // 'schn',
    /// <summary>
    ...
    /// </summary>
    public static readonly AudioObjectPropertySelector kAudioStreamPropertyVirtualFormat               = (AudioObjectPropertySelector)MacUtils.ConstructUIntConstantValueFromString("sfmt"u8); // 'sfmt',
    /// <summary>
    ...
    /// </summary>
    public static readonly AudioObjectPropertySelector kAudioStreamPropertyAvailableVirtualFormats     = (AudioObjectPropertySelector)MacUtils.ConstructUIntConstantValueFromString("sfma"u8); // 'sfma',
    /// <summary>
    /// An AudioStreamBasicDescription that describes the current data format for
    ...
    /// </summary>
    public static readonly AudioObjectPropertySelector kAudioStreamPropertyPhysicalFormat              = (AudioObjectPropertySelector)MacUtils.ConstructUIntConstantValueFromString("pft "u8); // 'pft ',
    /// <summary>
    /// An array of AudioStreamRangedDescriptions that describe the available data
    ...
    /// transactions.
    /// </summary>
    public static readonly AudioObjectPropertySelector kAudioStreamPropertyAvailablePhysicalFormats    = (AudioObjectPropertySelector)MacUtils.ConstructUIntConstantValueFromString("pfta"u8); // 'pfta'
}