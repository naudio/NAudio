...
internal static class AudioSystemObjectProperties
{
    ...
    /// </summary>
    public static readonly AudioObjectPropertySelector kAudioHardwarePropertyDevices                               = (AudioObjectPropertySelector)MacUtils.ConstructUIntConstantValueFromString("dev#"u8); // 'dev#',
    /// <summary>
    /// The AudioObjectID of the default input AudioDevice.
    /// </summary>
    public static readonly AudioObjectPropertySelector kAudioHardwarePropertyDefaultInputDevice                    = (AudioObjectPropertySelector)MacUtils.ConstructUIntConstantValueFromString("dIn "u8); // 'dIn ',
    /// <summary>
    /// The AudioObjectID of the default output AudioDevice.
    /// </summary>
    public static readonly AudioObjectPropertySelector kAudioHardwarePropertyDefaultOutputDevice                   = (AudioObjectPropertySelector)MacUtils.ConstructUIntConstantValueFromString("dOut"u8); // 'dOut',
    /// <summary>
    /// The AudioObjectID of the output AudioDevice to use for system 
    /// related sound from the alert sound to digital call progress.
    /// </summary>
    public static readonly AudioObjectPropertySelector kAudioHardwarePropertyDefaultSystemOutputDevice             = (AudioObjectPropertySelector)MacUtils.ConstructUIntConstantValueFromString("sOut"u8); // 'sOut',
    /// <summary>
    ...
    /// </summary>
    public static readonly AudioObjectPropertySelector kAudioHardwarePropertyTranslateUIDToDevice                  = (AudioObjectPropertySelector)MacUtils.ConstructUIntConstantValueFromString("uidd"u8); // 'uidd',
    /// <summary>
    ...
    /// </summary>
    public static readonly AudioObjectPropertySelector kAudioHardwarePropertyMixStereoToMono                       = (AudioObjectPropertySelector)MacUtils.ConstructUIntConstantValueFromString("stmo"u8); // 'stmo',
    /// <summary>
    /// An array of AudioObjectIDs that represent all the AudioPlugIn objects
    /// currently provided by the system
    /// </summary>
    public static readonly AudioObjectPropertySelector kAudioHardwarePropertyPlugInList                            = (AudioObjectPropertySelector)MacUtils.ConstructUIntConstantValueFromString("plg#"u8); // 'plg#',
    /// <summary>
    ...
    /// </summary>
    public static readonly AudioObjectPropertySelector kAudioHardwarePropertyTranslateBundleIDToPlugIn             = (AudioObjectPropertySelector)MacUtils.ConstructUIntConstantValueFromString("bidp"u8); // 'bidp',
    /// <summary>
    /// An array of the AudioObjectIDs for all the AudioTransportManager objects.
    /// </summary>
    public static readonly AudioObjectPropertySelector kAudioHardwarePropertyTransportManagerList                  = (AudioObjectPropertySelector)MacUtils.ConstructUIntConstantValueFromString("tmg#"u8); // 'tmg#',
    /// <summary>
    ...
    /// kAudioObjectUnknown as the value of the property.
    /// </summary>
    public static readonly AudioObjectPropertySelector kAudioHardwarePropertyTranslateBundleIDToTransportManager   = (AudioObjectPropertySelector)MacUtils.ConstructUIntConstantValueFromString("tmbi"u8); // 'tmbi',
    /// <summary>
    /// An array of AudioObjectIDs that represent all the 
    /// AudioBox objects currently provided by the system.
    /// </summary>
    public static readonly AudioObjectPropertySelector kAudioHardwarePropertyBoxList                               = (AudioObjectPropertySelector)MacUtils.ConstructUIntConstantValueFromString("box#"u8); // 'box#',
    /// <summary>
    ...
    /// as the value of the property.
    /// </summary>
    public static readonly AudioObjectPropertySelector kAudioHardwarePropertyTranslateUIDToBox                     = (AudioObjectPropertySelector)MacUtils.ConstructUIntConstantValueFromString("uidb"u8); // 'uidb',
    /// <summary>
    /// An array of AudioObjectIDs that represent all the AudioClockDevice objects 
    /// currently provided by the system.
    /// </summary>
    public static readonly AudioObjectPropertySelector kAudioHardwarePropertyClockDeviceList                       = (AudioObjectPropertySelector)MacUtils.ConstructUIntConstantValueFromString("clk#"u8); // 'clk#',
    /// <summary>
    ...
    /// kAudioObjectUnknown as the value of the property.
    /// </summary>
    public static readonly AudioObjectPropertySelector kAudioHardwarePropertyTranslateUIDToClockDevice             = (AudioObjectPropertySelector)MacUtils.ConstructUIntConstantValueFromString("uidc"u8); // 'uidc',
    /// <summary>
    ...
    /// </summary>
    public static readonly AudioObjectPropertySelector kAudioHardwarePropertyProcessIsMain                         = (AudioObjectPropertySelector)MacUtils.ConstructUIntConstantValueFromString("main"u8); // 'main',
    /// <summary>
    ...
    /// </summary>
    public static readonly AudioObjectPropertySelector kAudioHardwarePropertyIsInitingOrExiting                    = (AudioObjectPropertySelector)MacUtils.ConstructUIntConstantValueFromString("inot"u8); // 'inot',
    /// <summary>
    ...
    /// </summary>
    public static readonly AudioObjectPropertySelector kAudioHardwarePropertyUserIDChanged                         = (AudioObjectPropertySelector)MacUtils.ConstructUIntConstantValueFromString("euid"u8); // 'euid',
    /// <summary>
    ...
    /// </summary>
    public static readonly AudioObjectPropertySelector kAudioHardwarePropertyProcessInputMute                      = (AudioObjectPropertySelector)MacUtils.ConstructUIntConstantValueFromString("pmin"u8); // 'pmin',
    /// <summary>
    ...
    /// </summary>
    public static readonly AudioObjectPropertySelector kAudioHardwarePropertyProcessIsAudible                      = (AudioObjectPropertySelector)MacUtils.ConstructUIntConstantValueFromString("pmut"u8); // 'pmut',
    /// <summary>
    ...
    /// </summary>
    public static readonly AudioObjectPropertySelector kAudioHardwarePropertySleepingIsAllowed                     = (AudioObjectPropertySelector)MacUtils.ConstructUIntConstantValueFromString("slep"u8); // 'slep',
    /// <summary>
    ...
    /// </summary>
    public static readonly AudioObjectPropertySelector kAudioHardwarePropertyUnloadingIsAllowed                    = (AudioObjectPropertySelector)MacUtils.ConstructUIntConstantValueFromString("unld"u8); // 'unld',
    /// <summary>
    ...
    /// </summary>
    public static readonly AudioObjectPropertySelector kAudioHardwarePropertyHogModeIsAllowed                      = (AudioObjectPropertySelector)MacUtils.ConstructUIntConstantValueFromString("hogr"u8); // 'hogr',
    /// <summary>
    ...
    /// session.
    /// </summary>
    public static readonly AudioObjectPropertySelector kAudioHardwarePropertyUserSessionIsActiveOrHeadless         = (AudioObjectPropertySelector)MacUtils.ConstructUIntConstantValueFromString("user"u8); // 'user',
    /// <summary>
    ...
    /// </summary>
    public static readonly AudioObjectPropertySelector kAudioHardwarePropertyServiceRestarted                      = (AudioObjectPropertySelector)MacUtils.ConstructUIntConstantValueFromString("srst"u8); // 'srst',
    /// <summary>
    ...
    /// </summary>
    public static readonly AudioObjectPropertySelector kAudioHardwarePropertyPowerHint                             = (AudioObjectPropertySelector)MacUtils.ConstructUIntConstantValueFromString("powh"u8); // 'powh',
    /// <summary>
    /// An array of AudioObjectIDs that represent the Process objects 
    /// for all client processes currently connected to the system.
    /// </summary>
    public static readonly AudioObjectPropertySelector kAudioHardwarePropertyProcessObjectList                     = (AudioObjectPropertySelector)MacUtils.ConstructUIntConstantValueFromString("prs#"u8); // 'prs#',
    /// <summary>
    ...
    /// as the value of the property.
    /// </summary>
    public static readonly AudioObjectPropertySelector kAudioHardwarePropertyTranslatePIDToProcessObject           = (AudioObjectPropertySelector)MacUtils.ConstructUIntConstantValueFromString("id2p"u8); // 'id2p',
    /// <summary>
    /// An array of AudioObjectIDs that represent the Tap objects on the system.
    /// </summary>
    public static readonly AudioObjectPropertySelector kAudioHardwarePropertyTapList                               = (AudioObjectPropertySelector)MacUtils.ConstructUIntConstantValueFromString("tps#"u8); // 'tps#',
    /// <summary>
    ...
    /// </summary>
    public static readonly AudioObjectPropertySelector kAudioHardwarePropertyTranslateUIDToTap                     = (AudioObjectPropertySelector)MacUtils.ConstructUIntConstantValueFromString("uidt"u8); // 'uidt',
}