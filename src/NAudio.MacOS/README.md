...
The assembly/package provides wrappers for:

- [**Core Audio Framework**](https://developer.apple.com/documentation/coreaudio?language=objc): The audio HAL API. Through this API, playback and recording from an installed hardware device is possible.
